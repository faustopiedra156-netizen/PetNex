...
def crear_configuracion_inicial(apps, schema_editor):
    ...
    ConfiguracionNegocio.objects.get_or_create(
        ...
        defaults={
            ...
            'hero_descripcion': 'Ofrecemos banos, cortes, tratamientos de higiene y cuidado estético con atencion personalizada.',
            'descripcion_footer': 'Centro especializado en estetica, peluquería y spa para mascotas.',
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hero_descripcion', models.TextField(default='Servicios de higiene y cuidado estético con atencion personalizada.')),
                ('descripcion_footer', models.TextField(default='Centro especializado en estetica, peluquería y spa para mascotas.')),
